...
function normalizeCategoryName(category, channelName = '') {
    ...
    // Döndürmeden önce emoji'leri kaldır (tüm emoji aralıkları)
    return category.replace(/[\u{1F300}-\u{1F9FF}\u{2600}-\u{26FF}\u{2700}-\u{27BF}\u{FE00}-\u{FE0F}\u{200D}\u{1F600}-\u{1F64F}\u{1F680}-\u{1F6FF}\u{1F700}-\u{1F77F}\u{1F780}-\u{1F7FF}\u{1F800}-\u{1F8FF}\u{1F900}-\u{1F9FF}]/gu, '').trim();
}
        ...
        if (response && response.status === 200 && response.data) {
            ...
            for (let i = 0; i < lines.length; i++) {
                ...
                if (line.startsWith('#EXTINF')) {
                    ...
                    if (groupMatch) {
                        // Önce emoji'leri kaldır (tüm emoji aralıkları), sonra normalize et
                        const cleanGroupTitle = groupMatch[1].replace(/[\u{1F300}-\u{1F9FF}\u{2600}-\u{26FF}\u{2700}-\u{27BF}\u{FE00}-\u{FE0F}\u{200D}\u{1F600}-\u{1F64F}\u{1F680}-\u{1F6FF}\u{1F700}-\u{1F77F}\u{1F780}-\u{1F7FF}\u{1F800}-\u{1F8FF}\u{1F900}-\u{1F9FF}]/gu, '').trim();
                ...
                // URL satırı - stream URL'i
                    ...
                    if (currentChannel && currentUrl) {
                        ...
                        // Kategori adından emoji'leri kaldır (tüm emoji aralıkları)
                        finalCategory = finalCategory.replace(/[\u{1F300}-\u{1F9FF}\u{2600}-\u{26FF}\u{2700}-\u{27BF}\u{FE00}-\u{FE0F}\u{200D}\u{1F600}-\u{1F64F}\u{1F680}-\u{1F6FF}\u{1F700}-\u{1F77F}\u{1F780}-\u{1F7FF}\u{1F800}-\u{1F8FF}\u{1F900}-\u{1F9FF}]/gu, '').trim();
        ...
        if (matchedCategory) {
            ...
            categoryNames.forEach(catName => {
                ...
                if (categoryChannels.length > 0) {
                    ...
                    results.push({
                        // Kategori ID'sini oluştur - emoji'leri kaldır
                        const catNameClean = catName.replace(/[\u{1F300}-\u{1F9FF}\u{2600}-\u{26FF}\u{2700}-\u{27BF}\u{FE00}-\u{FE0F}\u{200D}\u{1F600}-\u{1F64F}\u{1F680}-\u{1F6FF}\u{1F700}-\u{1F77F}\u{1F780}-\u{1F7FF}\u{1F800}-\u{1F8FF}\u{1F900}-\u{1F9FF}]/gu, '').trim();
                        id: `zeusspor-category-${catNameClean.toLowerCase().replace(/\s+/g, '-').replace(/[^a-z0-9\-]/g, '')}`,
            ...
            channels.forEach(channel => {
                ...
                if (channelNameLower.includes(searchLower) || 
                    ...
                    if (matchedCategories.has(channel.category)) {
                        ...
                        const categoryNameClean = channel.category.replace(/[\u{1F300}-\u{1F9FF}\u{2600}-\u{26FF}\u{2700}-\u{27BF}\u{FE00}-\u{FE0F}\u{200D}\u{1F600}-\u{1F64F}\u{1F680}-\u{1F6FF}\u{1F700}-\u{1F77F}\u{1F780}-\u{1F7FF}\u{1F800}-\u{1F8FF}\u{1F900}-\u{1F9FF}]/gu, '').trim();
